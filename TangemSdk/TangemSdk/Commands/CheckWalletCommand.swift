...
@available(iOS 13.0, *)
public final class CheckWalletCommand: Command, WalletPointable {
    deinit {
	...
	public init(curve: EllipticCurve, publicKey: Data, walletPointer: WalletPointer?) {
        self.curve = curve
        self.publicKey = publicKey
		self.pointer = walletPointer
    }
