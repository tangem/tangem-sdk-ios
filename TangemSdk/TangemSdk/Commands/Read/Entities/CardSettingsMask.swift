...
public extension Card {
    ...
    struct SettingsMask: OptionSet, Codable, StringArrayConvertible, JSONStringConvertible, LogStringConvertible {
...
class SettingsMaskBuilder {
    ...
    func add(_ settings: Card.SettingsMask) {
        settingsMaskValue |= settings.rawValue
    }
    
    func build() -> Card.SettingsMask {
        return Card.SettingsMask(rawValue: settingsMaskValue)
    }
}

extension Card.SettingsMask {
