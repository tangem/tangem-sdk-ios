...
extension UserCodeType {
    ...
    var enterCodeTitle: String {
        switch self {
        case .accessCode:
            return String(format: "pin_enter".localized, name)
        case .passcode:
            return String(format: "pin_enter".localized, name)
        }
    }
    ...
    var changeCodeTitle: String {
        switch self {
        case .accessCode:
            return String(format: "pin_change_code_format".localized, name)
        case .passcode:
            return String(format: "pin_change_code_format".localized, name)
        }
    }
    ...
    var confirmCodeTitle: String {
        switch self {
        case .accessCode:
            return String(format: "pin_set_code_confirm_format".localized, name)
        case .passcode:
            return String(format: "pin_set_code_confirm_format".localized, name)
        }
    }
