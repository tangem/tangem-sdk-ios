...
public final class WriteFileCommand: Command {
    ...
    public init(
        ...
        counter: Int,
        fileVisibility: FileVisibility? = nil,
    ...
    public init(data: Data, fileVisibility: FileVisibility? = nil, walletPublicKey: Data? = nil) {
        ...
        startingSignature = nil
        finalizingSignature = nil
        counter = nil
    }
    ...
    public convenience init(_ file: FileToWrite) {
        ...
        case .byFileOwner(
            _,
            let startingSignature,
            let finalizingSignature,
            let counter,
            _,
            let fileVisibility,
            let walletPublicKey
    ...
    func serialize(with environment: SessionEnvironment) throws -> CommandApdu {
        ...
        case .initiateWritingFile:
            ...
            if let startingSignature = startingSignature, let counter = counter {
            ...
            if let fileVisibility = fileVisibility {
        ...
        case .confirmWritingFile:
            ...
            if let finalizingSignature = finalizingSignature {
    ...
    private func verifySignatures(publicKey: Data, cardId: String) -> Bool {
        ...
        guard let counter = counter,
              let startingSignature = startingSignature,
              let finalizingSignature = finalizingSignature else {
            return false
        }

        let startingSignatureIsValid = IssuerDataVerifier.verify(
            cardId: cardId,
        ...
        let finalizingSignatureIsValid = IssuerDataVerifier.verify(
            cardId: cardId,
            issuerData: data,
            issuerDataCounter: counter,
            publicKey: publicKey,
