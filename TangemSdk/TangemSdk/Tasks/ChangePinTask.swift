...
//                        case .pin3:
//                            session.environment.pin3 = PinCode(.pin3, value: pinChangeResult.currentPin.sha256())
//                        }
...
//        session.requestPinIfNeeded(.pin1) { pin1RequestResult in
//            switch pin1RequestResult {
//            case .success:
//                session.requestPinIfNeeded(.pin2) { pin2RequestResult in
