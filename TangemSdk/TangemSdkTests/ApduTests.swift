...
class ApduTests: XCTestCase {
    ...
    func testSerialization() throws {
        let apdu1 = CommandApdu(
            cla: 0x00,
            ins: 0x01,
            p1: 0x02,
            p2: 0x03,
            le: nil,
            tlv: Data(hexString: "0101010101")
        )
...
private extension CommandApdu {
    var NFCISO7816APDUDATA: Data {
        get throws {
            let nfcApdu = try XCTUnwrap(NFCISO7816APDU(data: serialize()))
