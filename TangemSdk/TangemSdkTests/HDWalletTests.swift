...
class HDWalletTests: XCTestCase {
    ...
    func testDerivation0() throws {
        let masterKey = ExtendedPublicKey(
            publicKey: Data(hexString: "03cbcaa9c98c877a26977d00825c956a238e8dddfbd322cce4f74b0b5bd6ace4a7"),
    ...
    func testPathDerivation() throws {
        ...
        XCTAssertEqual(
            childKey?.chainCode.hexString.lowercased(),
    ...
    func testPathDerivation1() throws {
        ...
        XCTAssertEqual(
            childKey?.publicKey.hexString.lowercased(),
