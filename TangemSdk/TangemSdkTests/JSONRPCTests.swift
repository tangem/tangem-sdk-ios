...
class JSONRPCTests: XCTestCase {
    ...
    func testCreateWallet() throws {
        let result = CreateWalletResponse(
            cardId: "c000111122223333",
            wallet: Card.Wallet(
                publicKey: Data(hexString: "5130869115a2ff91959774c99d4dc2873f0c41af3e0bb23d027ab16d39de1348"),
                chainCode: nil,
                curve: .secp256r1,
    ...
    func testImportWalletMnemonic() throws {
        let result = CreateWalletResponse(
            cardId: "c000111122223333",
            wallet: Card.Wallet(
                publicKey: Data(hexString: "029983A77B155ED3B3B9E1DDD223BD5AA073834C8F61113B2F1B883AAA70971B5F"),
    ...
    func testDerivePublicKey() throws {
        let result = ExtendedPublicKey(
            publicKey: Data(hexString: "0200300397571D99D41BB2A577E2CBE495C04AC5B9A97B7A4ECF999F23CE45E962"),
    ...
    func testDerivePublicKeys() throws {
        let keys = [
            try DerivationPath(rawPath: "m/44'/0'"): ExtendedPublicKey(publicKey: Data(hexString: "0200300397571D99D41BB2A577E2CBE495C04AC5B9A97B7A4ECF999F23CE45E962"),
                                                                       chainCode: Data(hexString: "537F7361175B150732E17508066982B42D9FB1F8239C4D7BFC490088C83A8BBB")),
    ...
    func testAttestCardKey() throws {
        let result = AttestCardKeyResponse(
            cardId: "c000111122223333",
    ...
    private func testPersonalizeConfig(name: String) throws {
        ...
        do {
            ...
            XCTAssertNoThrow(try JSONRPCConverter.makeDefaultConverter(networkService: .init(session: .shared, additionalHeaders: [:])).convert(request: request))
        } catch {
